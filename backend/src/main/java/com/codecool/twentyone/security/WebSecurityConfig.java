...
import com.codecool.twentyone.security.jwt.AuthEntryPointJwt;
import com.codecool.twentyone.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtUtils jwtUtils) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/clean").permitAll()
